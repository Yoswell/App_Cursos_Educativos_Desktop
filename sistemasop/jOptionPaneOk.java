...
public class jOptionPaneOk extends javax.swing.JFrame {

    public static String mensaje, etiqueta;
    
    public jOptionPaneOk(String mensaje, String etiqueta) {
        initComponents();
        setIconImage(new ImageIcon(getClass().getResource("../imagenes/Success_40973.png")).getImage());
    ...
    private void initComponents() {
        ...
        cerrarButton.setBackground(new java.awt.Color(204, 255, 204));
        cerrarButton.setForeground(new java.awt.Color(36, 39, 46));
        cerrarButton.setText("Ok");
        cerrarButton.setAlignmentY(0.0F);
        cerrarButton.setBorderColor(new java.awt.Color(52, 53, 65));
        cerrarButton.setBorderPainted(false);
        cerrarButton.setColor(new java.awt.Color(204, 255, 204));
        cerrarButton.setColorClick(new java.awt.Color(153, 255, 204));
        cerrarButton.setColorOver(new java.awt.Color(153, 255, 204));
        ...
        etiquetaLabel.setBackground(new java.awt.Color(51, 51, 51));
        ...
        mensajeLabel.setBackground(new java.awt.Color(51, 51, 51));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(jOptionPaneOk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jOptionPaneOk(mensaje, etiqueta).setVisible(true);
            }
        });
    }
